...
struct KernelTable {
    ...
    void (*rotate_uniform_imag_pairs_const)(
        double* re,
        double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*rotate_real_pair_flip_pairs_const)(
        double* re,
        double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*rotate_general_pairs_const)(
        double* re,
        double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*rotate_general_pairs_mixed)(
        double* re,
        double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*promote_first_dormant_rotation_range)(
        double* re,
        double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*last_z_measure_true_prob_range)(
        const double* re,
        const double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*diagonal_measure_true_prob_range)(
        const double* re,
        const double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*nondiagonal_measure_true_prob_range)(
        const double* re,
        const double* im,
        std::size_t leading_shots,
        int active_shots,
    ...
    void (*nondiagonal_project_range)(
        const double* re,
        const double* im,
        double* scratch_re,
        double* scratch_im,
